...
napi_value invoke(napi_env env, napi_value js_lib_dir, napi_value js_lib_name, napi_value js_fn_name, napi_value js_args, napi_value js_argtypes, napi_value js_return_type,
                  void (*call_fn)(char *, char *, char *, u_int8_t, linker_value[ARG_MAX], linker_type, void *), void (*finalize)(napi_env, void *, void *))
{
